...
while(1):
		...
		file.close()
		file = open("6", "r")
        my_pwm_2.ChangeDutyCycle(int(file.read()))
		file.close()
		file = open("13", "r") 
        my_pwm_3.ChangeDutyCycle(int(file.read()))
		file.close()
		file = open("26", "r") 
        my_pwm_4.ChangeDutyCycle(int(file.read()))
		file.close()
		file = open("19", "r") 
        my_pwm_5.ChangeDutyCycle(int(file.read()))
		file.close()
		file = open("21", "r") 
        my_pwm_6.ChangeDutyCycle(int(file.read()))
